...
const badgeVariants = cva(
  "inline-flex items-center gap-1.5 rounded-[var(--aio-r-chip)] border border-transparent px-2.5 py-1 text-[11px] font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
